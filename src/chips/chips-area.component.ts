...
@NgModule({
    declarations: [IgxChipsAreaComponent, IgxChipComponent, IgxPrefixConnectorDirective, IgxSuffixConnectorDirective],
    exports: [IgxChipsAreaComponent, IgxChipComponent, IgxPrefixConnectorDirective, IgxSuffixConnectorDirective],
    imports: [IgxRippleModule, CommonModule, IgxIconModule, IgxButtonModule, IgxAvatarModule]
})
export class IgxChipsAreaModule { }
